...
const Login = () => {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      // Send the user data to your server or handle it as needed
      router.push("/");
    } catch (error) {
  ...
  return (
    <form onSubmit={formik.handleSubmit} className="flex flex-col min-h-screen">
      <div className="container flex justify-center items-center min-h-screen min-w-full shadow-lg rounded-2xl hsl(var(--nextui-background) / 0.7)">
        <div className="box flex flex-col gap-5 p-4 bg-gray-200">
          <div className="flex justify-between">
            <img src="/mylogo.png" width={90} height={30} className="rounded" />
            <h2 className="pt-4 heading text-right text-3xl text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-blue-500 m-1">
              Express Rides
            </h2>
          </div>
          ...
          <button
            ...
            className="bg white border w-full rounded-xl mt-1 flex justify-center "
          >
            <svg
              className="mr-3 text-sm"
              xmlns="http://www.w3.org/2000/svg"
